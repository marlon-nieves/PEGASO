...
<div class="row">
    <div class="col">
        <h1 class="alert alert-primary text-center">AGREGAR VENDEDOR</h1>
    </div>
</div>
<div class="row">
    <div class="col text-left">
        <a href="/administrador/vendedores" class="btn btn-danger">Atras</a>
    </div>
</div>
<br>
<div class="row">
    <div class="col">
        <form method="POST" action="{{url('/vendedores')}}" enctype="multipart/form-data">
        {{ csrf_field() }}
            @csrf
